...
public class Robot extends IterativeRobot {
	...
	//File outFile = new File(path.toString() + "/log_" + dateTime.format(DateTimeFormatter.ofPattern("uu_MM_dd_HH_mm_ss")) + ".csv");
	public static BufferedWriterFRC logger;
	RobotMap.loggerData.registerDoubleStream("Joystick Y", "Push",() -> Robot.oi.driver.getY());
