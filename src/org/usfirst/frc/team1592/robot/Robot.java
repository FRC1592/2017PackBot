...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		// Put Autonomous Mode Choices on the Smart Dashboard
		//chooser = new SendableChooser<Command>();
		// chooser.addObject("My Auto", new MyAutoCommand());
		//SmartDashboard.putData("Auto mode", chooser);
		if (Constants.DEBUG) System.out.println("Robot init");
		

		try {
					
			RobotMap.eventOutFile=new FileOutputStream(RobotMap.logPath.toString() + "/log_" + 
					RobotMap.day.format(DateTimeFormatter.ofPattern("uu_MM_dd_HH_mm_ss")) + ".csv");
			RobotMap.logger=new BufferedWriterFRC();
