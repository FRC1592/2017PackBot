...
public class WriteData extends Command{
    ...
    protected void initialize() {
		...
		*/
    	DoubleSupplier pi = () -> {return 3.14159;};
    	RobotMap.loggerOut.registerDoubleStream("Joystick Y", "Push",pi);
    	RobotMap.loggerOut.endRegistration();
    	try {
			RobotMap.loggerOut.outputHeader();
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
